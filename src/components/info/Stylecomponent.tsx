      ...
      <Grid gutter={20} className="customGrid">
        <GridCol span={12}>
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' , fontWeight: 'bold' }}>
            <Image src={`https://curmgtrnrpyjsizyhdzy.supabase.co/storage/v1/object/public/landing-bucket/${imagePath}`} alt="Component Image" width={600} height={500} style={{ objectFit: 'contain', maxWidth: '100%', maxHeight: '100%' }} unoptimized />
          </div>
        </GridCol>
        <GridCol span={12} className="customGridCol">
          <div className="subGrid">
            <Title order={2} fw={750} style={{ whiteSpace: "pre-wrap", wordWrap: "break-word" }}>{sectionTitle}</Title>
    ...
    case "LeftComponent":
      layout = (
        <SimpleGrid className="customGridCol" cols={gridCols}>
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' , fontWeight: 'bold' }}>
            <Image src={`https://curmgtrnrpyjsizyhdzy.supabase.co/storage/v1/object/public/landing-bucket/${imagePath}`} alt="Component Image" width={450} height={300} style={{ objectFit: "contain", maxWidth: '100%', maxHeight: '100%' }} unoptimized/>
          </div>
          <div className="subGrid">
            <Title  order={2}fw={750} style={{ whiteSpace: "pre-wrap", wordWrap: "break-word" }}>{sectionTitle}</Title>
            <Text className={classes.p} style={{ marginTop: "10px", color: "#555", textWrap: "wrap", textAlign: "justify" }}>{description}</Text>
    ...
    case "RightComponent":
      layout = (
        <SimpleGrid className="customGridCol" cols={gridCols}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' , fontWeight: 'bold' }}>
            <Image src={`https://curmgtrnrpyjsizyhdzy.supabase.co/storage/v1/object/public/landing-bucket/${imagePath}`} alt="Component Image" width={400} height={300} style={{ objectFit: "contain", maxWidth: '100%', maxHeight: '100%' }} unoptimized />
          </div>
        </SimpleGrid>
      );
      break;
